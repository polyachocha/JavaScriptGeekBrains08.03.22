    ...
    template: `
        <section class="cart" v-show="$root.$refs.showCart.showCart">
            <div class="cart__container">
                ...
                <cart-item-comp v-for="item of cartItems" 
                :key="item.id_product"
                :cart-item="item"
                :img="item.img"
                @remove="remove"></cart-item-comp>
            </div>
            <div class="cart__icon-close">
...
Vue.component('CartItemComp', {
    props: ['cartItem'],
    template: `
        <section class="cart__product">
            <div class="cart__product__img">
                <img :src="cartItem.img" alt="Cart Product Image">
            </div>
